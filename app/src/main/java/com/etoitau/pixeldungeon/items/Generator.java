...
import com.etoitau.pixeldungeon.items.potions.*;
import com.etoitau.pixeldungeon.items.rings.*;
import com.etoitau.pixeldungeon.items.scrolls.*;
import com.etoitau.pixeldungeon.items.wands.*;
import com.etoitau.pixeldungeon.items.weapon.*;
import com.etoitau.pixeldungeon.items.weapon.melee.*;
import com.etoitau.pixeldungeon.items.weapon.missiles.*;
import com.etoitau.pixeldungeon.plants.*;
