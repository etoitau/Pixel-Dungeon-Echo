...
public class Heap implements Bundlable {
    ...
    public void restoreFromBundle(Bundle bundle) {
        ...
        // Error:(373, 96) java: incompatible types: java.util.Collection<com.watabau.utils.Bundlable> cannot be converted to java.util.Collection<? extends com.etoitau.pixeldungeon.items.Item>
