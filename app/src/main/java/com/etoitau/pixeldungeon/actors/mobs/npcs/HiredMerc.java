...
import com.etoitau.pixeldungeon.actors.skills.MercArcherSkillA;
import com.etoitau.pixeldungeon.actors.skills.MercArcherSkillB;
import com.etoitau.pixeldungeon.actors.skills.MercBruteSkillA;
import com.etoitau.pixeldungeon.actors.skills.MercThiefSkillA;
import com.etoitau.pixeldungeon.actors.skills.MercWizardSkillA;
        ...
        public int getDefence(int level) {
            switch (this) {
                ...
                case Archer:
                    return 3 * level;
                case ArcherMaiden:
                    return 3 + level + getStrength(level); // Can't equip armor
            }
            return 1;
        }
        ...
        public void setSkills(HiredMerc merc) {
            ...
            switch (this) {
                case Brute:
                    ...
                    break;
                case Wizard:
                    merc.skill = new MercWizardSkillA();
                    merc.skill.level = 1;
                    break;
                case Thief:
                    merc.skill = new MercThiefSkillA();
                    merc.skill.level = 1;
                    break;
                case Archer:
                    merc.skill = new MercArcherSkillA();
                    merc.skill.level = 1;
                    break;
                case ArcherMaiden:
                    merc.skill = new MercArcherSkillA();
                    merc.skill.level = 1;
                    merc.skillb = new MercArcherSkillB();
                    merc.skillb.level = 4;
                    break;
            }
        }
        ...
        public void setEquipment(HiredMerc merc) {
            switch (this) {
                ...
                case Wizard:
                    ...
                    break;
                case Thief:
                    merc.weapon = new Dagger().identify();
                    merc.armor = new ClothArmor().identify();
                    merc.carrying = new PotionOfHealing();
                    break;
                case Archer:
                    merc.weapon = new Bow(1);
                    merc.armor = new ClothArmor().identify();
                    merc.carrying = new PotionOfHealing();
                    break;
                case ArcherMaiden:
                    merc.weapon = new FrostBow(1);
                    merc.carrying = new PotionOfHealing().identify();
                    break;
            }
        }
