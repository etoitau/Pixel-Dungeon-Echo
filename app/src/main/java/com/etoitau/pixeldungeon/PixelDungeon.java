...
public class PixelDungeon extends Game {
	...
	public PixelDungeon() {
		...
		com.watabau.utils.Bundle.addAlias(
			com.etoitau.pixeldungeon.items.scrolls.ScrollOfUpgrade.class,
			"com.watabou.pixeldungeon.items.scrolls.ScrollOfEnhancement" );
		com.watabau.utils.Bundle.addAlias(
			com.etoitau.pixeldungeon.actors.blobs.WaterOfHealth.class,
			"com.watabou.pixeldungeon.actors.blobs.Light" );
		com.watabau.utils.Bundle.addAlias(
			com.etoitau.pixeldungeon.items.rings.RingOfMending.class,
			"com.watabou.pixeldungeon.items.rings.RingOfRejuvenation" );
		com.watabau.utils.Bundle.addAlias(
			com.etoitau.pixeldungeon.items.wands.WandOfReach.class,
			"com.watabou.pixeldungeon.items.wands.WandOfTelekenesis" );
		com.watabau.utils.Bundle.addAlias(
			com.etoitau.pixeldungeon.actors.blobs.Foliage.class,
			"com.watabou.pixeldungeon.actors.blobs.Blooming" );
		com.watabau.utils.Bundle.addAlias(
			com.etoitau.pixeldungeon.actors.buffs.Shadows.class,
			"com.watabou.pixeldungeon.actors.buffs.Rejuvenation" );
		com.watabau.utils.Bundle.addAlias(
			com.etoitau.pixeldungeon.items.scrolls.ScrollOfPsionicBlast.class,
			"com.watabou.pixeldungeon.items.scrolls.ScrollOfNuclearBlast" );
		com.watabau.utils.Bundle.addAlias(
			com.etoitau.pixeldungeon.actors.hero.Hero.class,
			"com.watabou.pixeldungeon.actors.Hero" );
		com.watabau.utils.Bundle.addAlias(
			com.etoitau.pixeldungeon.actors.mobs.npcs.Shopkeeper.class,
			"com.watabou.pixeldungeon.actors.mobs.Shopkeeper" );
		// 1.6.1
		com.watabau.utils.Bundle.addAlias(
			com.etoitau.pixeldungeon.items.quest.DriedRose.class,
			"com.watabou.pixeldungeon.items.DriedRose" );
		com.watabau.utils.Bundle.addAlias(
			com.etoitau.pixeldungeon.actors.mobs.npcs.MirrorImage.class,
			"com.watabou.pixeldungeon.items.scrolls.ScrollOfMirrorImage$MirrorImage" );
		// 1.6.4
		com.watabau.utils.Bundle.addAlias(
			com.etoitau.pixeldungeon.items.rings.RingOfElements.class,
			"com.watabou.pixeldungeon.items.rings.RingOfCleansing" );
		com.watabau.utils.Bundle.addAlias(
			com.etoitau.pixeldungeon.items.rings.RingOfElements.class,
			"com.watabou.pixeldungeon.items.rings.RingOfResistance" );
		com.watabau.utils.Bundle.addAlias(
			com.etoitau.pixeldungeon.items.weapon.missiles.Boomerang.class,
			"com.watabou.pixeldungeon.items.weapon.missiles.RangersBoomerang" );
		com.watabau.utils.Bundle.addAlias(
			com.etoitau.pixeldungeon.items.rings.RingOfPower.class,
			"com.watabou.pixeldungeon.items.rings.RingOfEnergy" );
		// 1.7.2
		com.watabau.utils.Bundle.addAlias(
			com.etoitau.pixeldungeon.plants.Dreamweed.class,
			"com.watabou.pixeldungeon.plants.Blindweed" );
		com.watabau.utils.Bundle.addAlias(
			com.etoitau.pixeldungeon.plants.Dreamweed.Seed.class,
			"com.watabou.pixeldungeon.plants.Blindweed$Seed" );
		// 1.7.4
		com.watabau.utils.Bundle.addAlias(
			com.etoitau.pixeldungeon.items.weapon.enchantments.Shock.class,
			"com.watabou.pixeldungeon.items.weapon.enchantments.Piercing" );
		com.watabau.utils.Bundle.addAlias(
			com.etoitau.pixeldungeon.items.weapon.enchantments.Shock.class,
			"com.watabou.pixeldungeon.items.weapon.enchantments.Swing" );
		com.watabau.utils.Bundle.addAlias(
			com.etoitau.pixeldungeon.items.scrolls.ScrollOfEnchantment.class,
		...
		// 1.8.0
		com.watabau.utils.Bundle.addAlias(
			com.etoitau.pixeldungeon.actors.mobs.FetidRat.class,
			"com.watabou.pixeldungeon.actors.mobs.npcs.Ghost$FetidRat" );
		com.watabau.utils.Bundle.addAlias(
			com.etoitau.pixeldungeon.plants.Rotberry.class,
			"com.watabou.pixeldungeon.actors.mobs.npcs.Wandmaker$Rotberry" );
		com.watabau.utils.Bundle.addAlias(
			com.etoitau.pixeldungeon.plants.Rotberry.Seed.class,
